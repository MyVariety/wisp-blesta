...
Configure::set('Wisp.page_refresh_rate_fast', '5000');

// Polling interval for how often to refresh page content on pages that support it
// Note: Set to number of milliseconds (1000 = 1 second)
Configure::set('Wisp.page_refresh_rate', '30000');

// Email templates
Configure::set('Wisp.email_templates', [
    'en_us' => [
        'lang' => 'en_us',
...
<p>Log into your account to start and manage your Minecraft Server! Be sure to start your Minecraft server for the first time from within our panel so that you can agree to the Mojang EULA.</p>'
    ]
]);